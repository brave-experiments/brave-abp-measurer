...
async function record (url, dwellTime, filterListUrl, filterListText, records, debug = false, prevCrawlId = null, metadata = null) {
    ...
    const crawlId = await idForCrawl(client, siteId, dwellTime, url, prevCrawlId, metadata);
